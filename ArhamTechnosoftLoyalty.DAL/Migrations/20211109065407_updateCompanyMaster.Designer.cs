...
namespace ArhamTechnosoftLoyalty.DAL.Migrations
{
    ...
    [Migration("20211109065407_updateCompanyMaster")]
    partial class updateCompanyMaster
    {
            ...
            modelBuilder.Entity("ArhamTechnosoftLoyalty.Models.EntityModel.CompanyMaster", b =>
                {
                    ...
                    b.Property<long?>("CompanyMailEmailId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("CompanyPhoneIdPhoneId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CompanyMailEmailId");

                    b.HasIndex("CompanyPhoneIdPhoneId");
            ...
            modelBuilder.Entity("ArhamTechnosoftLoyalty.Models.EntityModel.CompanyMaster", b =>
                {
                    ...
                    b.HasOne("ArhamTechnosoftLoyalty.Models.EntityModel.Email", "CompanyMail")
                        .WithMany()
                        .HasForeignKey("CompanyMailEmailId");

                    b.HasOne("ArhamTechnosoftLoyalty.Models.EntityModel.Phone", "CompanyPhoneId")
                        .WithMany()
                        .HasForeignKey("CompanyPhoneIdPhoneId");

                    b.Navigation("CompanyAddress");

                    b.Navigation("CompanyMail");

                    b.Navigation("CompanyPhoneId");
                });
